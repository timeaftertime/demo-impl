...
public class DFABuilderTest {
	...
	public void testCombineDFA() {
		// s0--f-->s1--e-->s2--e-->s3
		// +---i-->s4--e-->s5
		Node s0 = DFABuilder.newDFA(NFABuilder.newNFA(new HashSet<>(Arrays
				.asList(new TokenDefinition("fee", TEST_TOKEN_CODE1), new TokenDefinition("fie", TEST_TOKEN_CODE2)))));
