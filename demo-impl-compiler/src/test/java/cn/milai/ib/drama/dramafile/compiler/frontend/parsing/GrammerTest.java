...
import cn.milai.demoimpl.compiler.frontend.parsing.Grammer;
import cn.milai.demoimpl.compiler.frontend.parsing.GrammerReader;
import cn.milai.demoimpl.compiler.frontend.parsing.Keywords;
import cn.milai.demoimpl.compiler.frontend.parsing.NonTerminalSymbol;
import cn.milai.demoimpl.compiler.frontend.parsing.Production;
import cn.milai.demoimpl.compiler.frontend.parsing.Symbol;
...
public class GrammerTest {
	...
	public void testSelectSet() {
		// Expr
		checkSelects(grammer.symbolOf(codes[0]), Arrays.asList(Creator.asSet("IDENTIFIER"),
				Creator.asSet("IDENTIFIER", "BRACKET_LEFT", "INT", "FLOAT")));
		// CFG
		checkSelects(grammer.symbolOf(codes[1]),
				Arrays.asList(Creator.asSet("IDENTIFIER", "BRACKET_LEFT", "INT", "FLOAT"), Creator.asSet("IDENTIFIER"),
						Creator.asSet("IDENTIFIER", "BRACKET_LEFT", "INT", "FLOAT")));
		// Factor
		checkSelects(grammer.symbolOf(codes[2]), Arrays.asList(Creator.asSet("IDENTIFIER"),
				Creator.asSet("BRACKET_LEFT"), Creator.asSet("INT"), Creator.asSet("FLOAT")));
		// Term
		checkSelects(grammer.symbolOf(codes[3]), Arrays.asList(Creator.asSet("BRACKET_LEFT"), Creator.asSet("INT"),
				Creator.asSet("FLOAT"), Creator.asSet("IDENTIFIER")));
		// Expr'
		checkSelects(grammer.symbolOf(codes[4]),
				Arrays.asList(Creator.asSet(Keywords.EPSILON, Keywords.EOF, "PLUS", "MINUS", "BRACKET_RIGHT"),
						Creator.asSet("PLUS"), Creator.asSet("MINUS")));
		// Term'
		checkSelects(grammer.symbolOf(codes[5]),
				Arrays.asList(Creator.asSet(Keywords.EPSILON, Keywords.EOF, "PLUS", "MINUS", "BRACKET_RIGHT"),
						Creator.asSet("TIMES"), Creator.asSet("DIVISION")));
		// CFG'
		checkSelects(grammer.symbolOf(codes[6]), Arrays.asList(Creator.asSet("PLUS"), Creator.asSet("MINUS")));
	}
	...
	public void testFirstAndFollowSets() {
		/**
		 * FIRST FOLLOW Expr IDENTIFIER,BRACKET_LEFT,INT,FLOAT
		 * $,PLUS,MINUS,BRACKET_RIGHT CFG IDENTIFIER,BRACKET_LEFT,INT,FLOAT $ Factor
		 * IDENTIFIER,BRACKET_LEFT INT,FLOAT $,PLUS,MINUS,BRACKET_RIGHT,TIMES,DIVISION,
		 * Term IDENTIFIER,BRACKET_LEFT,INT,FLOAT $,PLUS,MINUS,BRACKET_RIGHT Expr'
		 * PLUS,MINUS,ϵ $,PLUS,MINUS,BRACKET_RIGHT Term' TIMES,DIVISION,ϵ
		 * $,PLUS,MINUS,BRACKET_RIGHT CFG' PLUS,MINUS, $
		 */
	...
	public void testParseProductions() {
		...
		// Expr
		checkNonTerminal(grammer.symbolOf(codes[0]), Arrays
				.asList(Arrays.asList("IDENTIFIER", "ASSIGN", "Expr", "Expr\'"), Arrays.asList("Term", "Expr\'")));
		// CFG
		checkNonTerminal(grammer.symbolOf(codes[1]), Arrays.asList(Arrays.asList("Term"),
				Arrays.asList("IDENTIFIER", "ASSIGN", "Expr"), Arrays.asList("Expr", "CFG\'")));
		// Factor
		checkNonTerminal(grammer.symbolOf(codes[2]), Arrays.asList(Arrays.asList("IDENTIFIER"),
				Arrays.asList("BRACKET_LEFT", "Expr", "BRACKET_RIGHT"), Arrays.asList("INT"), Arrays.asList("FLOAT")));
		// Term
		checkNonTerminal(grammer.symbolOf(codes[3]),
				Arrays.asList(Arrays.asList("BRACKET_LEFT", "Expr", "BRACKET_RIGHT", "Term\'"),
						Arrays.asList("INT", "Term\'"), Arrays.asList("FLOAT", "Term\'"),
						Arrays.asList("IDENTIFIER", "Term\'")));
		// Expr'
		checkNonTerminal(grammer.symbolOf(codes[4]), Arrays.asList(Arrays.asList(Keywords.EPSILON),
				Arrays.asList("PLUS", "Term", "Expr\'"), Arrays.asList("MINUS", "Term", "Expr\'")));
		// Term'
		checkNonTerminal(grammer.symbolOf(codes[5]), Arrays.asList(Arrays.asList(Keywords.EPSILON),
				Arrays.asList("TIMES", "Factor", "Term\'"), Arrays.asList("DIVISION", "Factor", "Term\'")));
		// CFG'
		checkNonTerminal(grammer.symbolOf(codes[6]),
				Arrays.asList(Arrays.asList("PLUS", "Term"), Arrays.asList("MINUS", "Term")));
	}
